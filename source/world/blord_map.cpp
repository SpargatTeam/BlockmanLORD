...
{
	NBT_Debug("findSaves begin %s", base.c_str());
	...
	{
		// only check saves_base for level.dat if we didn't find a saves dir, the passed base dir may have a spurrious level.dat
